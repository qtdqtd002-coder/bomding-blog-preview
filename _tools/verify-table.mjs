...
const nTools = list ? list.ids.split(',').length : 0;
chk('도구 목록 = 썸네일·티어표·표 차례 · «표 제작» 선택 · 메타 = 도구 수 · 표 아이콘', !!list && list.ids.startsWith('thumb,tier,table') && list.on === 'table' && list.name === '표 제작' && list.meta.includes(String(nTools)) && list.svg, list);   /* 도구가 더 붙어도(09-12 다른 세션 작업 중) 깨지지 않게 순서·개수 일치만 */
