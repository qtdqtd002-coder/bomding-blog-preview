...
const CONTENT_GATES = {
  '겜더쿠': {
    ...
    quotas: [
      // 2026-07-18: ⑯스펙시트(라벨 "핵심 요약", v2 시각 시그니처)는 ②한눈에의 변형 → 같은 쿼터로 합산
      // (요약 박스 가족이 매 글 반복되면 그게 새 지문 — output-format §3-2-b / tistory-seo §4-3)
      { name: '요약 박스(②한눈에·⑯핵심요약)', re: /이 글 한눈에|핵심 요약/, max: 6 },
